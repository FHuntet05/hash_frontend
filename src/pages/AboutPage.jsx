// RUTA: frontend/src/pages/AboutPage.jsx (v2.0 - CONTENIDO EVERCHAIN BOT)
    ...
    <StaticPageLayout title={t('aboutPage.title', 'Informe Oficial del Proyecto')}>
      <div className="bg-card/70 backdrop-blur-md p-6 sm:p-8 rounded-2xl border border-border shadow-subtle text-text-secondary">
        ...
        <div className="space-y-2 text-sm">
          ...
          <p>🔐 <strong>Infraestructura:</strong> EverChain Core (red de validadores distribuidos + cifrado cuántico-resistente)</p>
        ...
        <InfoSection 
          ...
          items={[
            { title: 'EverChain Core Network:', details: ['Blockchain de consenso híbrido (Proof-of-Stake + Proof-of-Verification).', 'Nodos validados en más de 30 países.', 'Registro inmutable y trazabilidad en tiempo real.'] },
        ...
        <InfoSection 
          title="⚙ FUNCIONAMIENTO DE EVERCHAIN BOT"
          items={[
        ...
        <InfoSection 
          title="📈 POR QUÉ CONFIAR EN EVERCHAIN BOT"
          items={[
            { title: 'Blockchain EverChain Core:', details: ['Validadores distribuidos, consenso híbrido, resistencia a ataques.'] },
        ...
        <p className="text-center text-text-secondary font-semibold">
          🔗 EverChain Bot no es solo un bot: es una infraestructura autónoma sobre blockchain que combina seguridad, liquidez y crecimiento sostenible.
        </p>
